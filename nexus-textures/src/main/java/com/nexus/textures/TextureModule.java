...
public class TextureModule {
    public static void load() {
        try {
            ...
            if (is == null) {
                TextureMod.LOGGER.warn("[Textures] Manifest not found.");
                return;
            }
            ...
            TextureMod.LOGGER.info("[Textures] {} ASTC textures loaded.", count);
        } catch (Exception e) {
            TextureMod.LOGGER.error("[Textures] Load failed: {}", e.getMessage());
        }
    }
}
